...
cp ./server/ca-cert.pem ./client/tls-root-cert/rca-trading-ca-cert.pem
cat ./client/tls-root-cert/rca-trading-ca-cert.pem

# Copy the TLS certificate from the TLS_CA.
mkdir -p ./client/tls-ca
cp ./server/tls-cert.pem ./client/tls-ca/rca-trading-tls-cert.pem
cat ./client/tls-ca/rca-trading-tls-cert.pem
