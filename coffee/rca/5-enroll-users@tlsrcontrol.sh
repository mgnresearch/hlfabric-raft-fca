...
echo "Coffee Peers @ TLS"
fabric-ca-client enroll -u https://peer0-coffee:peer0-pwd@${TLSR_SERVER} --mspdir users/peer0/tls-msp --enrollment.profile tls --csr.hosts peer0.coffee.blockchain.biz
# Adapt the "_sk" file
sleep 1
cp ./users/peer0/tls-msp/keystore/*_sk ./users/peer0/tls-msp/keystore/key.pem

fabric-ca-client enroll -u https://peer1-coffee:peer1-pwd@${TLSR_SERVER} --mspdir users/peer1/tls-msp --enrollment.profile tls --csr.hosts peer1.coffee.blockchain.biz
# Adapt the "_sk" file
sleep 1
