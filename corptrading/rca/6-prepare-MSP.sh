...
echo "NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/rca-corptrading-blockchain-biz-6005.pem
...
# - - - 
export CRYPTO_PLACE=./users/orderer3
echo "admincerts > "${CRYPTO_PLACE}
mkdir -p ${CRYPTO_PLACE}/msp/admincerts
cp ./users/admin/msp/signcerts/cert.pem ${CRYPTO_PLACE}/msp/admincerts/${ORG_NAME}-admin-cert.pem
...
# - - - 
export CRYPTO_PLACE=./users/orderer4
echo "admincerts > "${CRYPTO_PLACE}
mkdir -p ${CRYPTO_PLACE}/msp/admincerts
cp ./users/admin/msp/signcerts/cert.pem ${CRYPTO_PLACE}/msp/admincerts/${ORG_NAME}-admin-cert.pem
